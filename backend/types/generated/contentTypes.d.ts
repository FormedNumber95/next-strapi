...
export interface ApiGodGod extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    domain: Schema.Attribute.Enumeration<
      ['guerra', 'sabidur\u00EDa', 'mar', 'inframundo', 'amor']
    >;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<'oneToMany', 'api::god.god'> &
      Schema.Attribute.Private;
    myths: Schema.Attribute.Relation<'oneToMany', 'api::myth.myth'>;
    name: Schema.Attribute.String &
      Schema.Attribute.Required &
      Schema.Attribute.Unique;
    publishedAt: Schema.Attribute.DateTime;
...
export interface ApiMythMyth extends Struct.CollectionTypeSchema {
  collectionName: 'myths';
  info: {
    displayName: 'myth';
    pluralName: 'myths';
    singularName: 'myth';
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    god: Schema.Attribute.Relation<'manyToOne', 'api::god.god'>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<'oneToMany', 'api::myth.myth'> &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    slug: Schema.Attribute.UID;
    summary: Schema.Attribute.String;
    temples: Schema.Attribute.Relation<'manyToMany', 'api::temple.temple'>;
...
export interface ApiTempleTemple extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    myths: Schema.Attribute.Relation<'manyToMany', 'api::myth.myth'>;
    name: Schema.Attribute.String;
